...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"./Manually Attendance/-------Check atttendance-------"')
    ...
    fill_manual_attendance = tk.Button(sb, text="Fill Attendance",command=fill_attendance, fg="white", bg="deep pink", width=25, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def subjectchoose():
    ...
    attf = tk.Button(windo,  text="Check Sheets",command=Attf,fg="black"  ,bg="lawn green"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('kenit', 14, ' bold '))
    attf.place(x=420, y=255)

    sub = tk.Label(windo, text="ENTER SUBJECT", width=15, height=2, fg="white", bg="blue2", font=('kenit', 15, ' bold '))
    sub.place(x=30, y=100)
    ...
    fill_a = tk.Button(windo, text="FILL ATTENDANCE", fg="white",command=Fillattendances, bg="deep pink", width=20, height=2,
                       activebackground="Red", font=('kenit', 15, ' bold '))
    fill_a.place(x=260, y=160)
    windo.mainloop()
...
def admin_panel():
    ...
    Nt = tk.Label(win, text="Attendance filled Successfully", bg="Green", fg="white", width=40,
                  height=2, font=('kenit', 19, 'bold'))
    # Nt.place(x=120, y=350)

    un = tk.Label(win, text="ENTER USERNAME", width=20, height=2, fg="white", bg="blue2",
                   font=('kenit', 15, ' bold '))
    un.place(x=30, y=50)

    pw = tk.Label(win, text="ENTER PASSWORD", width=20, height=2, fg="white", bg="blue2",
                  font=('kenit', 15, ' bold '))
    pw.place(x=30, y=150)
    ...
    un_entr.place(x=320, y=55)

    def c11():
        pw_entr.delete(first=0, last=22)

    pw_entr = tk.Entry(win, width=20,show="*", bg="yellow", fg="red", font=('times', 23, ' bold '))
    pw_entr.place(x=320, y=155)

    c0 = tk.Button(win, text="Clear", command=c00, fg="black", bg="gray", width=10, height=1,
                            activebackground="Red", font=('times', 15, ' bold '))
    c0.place(x=690, y=55)

    c1 = tk.Button(win, text="Clear", command=c11, fg="black", bg="gray", width=10, height=1,
                   activebackground="Red", font=('times', 15, ' bold '))
    c1.place(x=690, y=155)

    Login = tk.Button(win, text="LOGIN", fg="black", bg="lime green", width=20,
                       height=2,
                       activebackground="Red",command=log_in, font=('kenit', 15, ' bold '))
    Login.place(x=350, y=250)
    win.mainloop()
...
message = tk.Label(window, text="FACE ATTENDANCE", bg="snow", fg="black", width=35,
                   height=3, font=('Bebas Neue', 40 , 'bold'))
...
lbl = tk.Label(window, text="ENTER ENROLLMENT", width=20, height=3, fg="black", bg="snow", font=('kenit', 18, ' bold '))
...
txt = tk.Entry(window, validate="key", width=20, bg="white", fg="green", font=('times', 25, ' bold '))
txt['validatecommand'] = (txt.register(testVal),'%P','%d')
txt.place(x=550, y=210)

lbl2 = tk.Label(window, text="ENTER NAME", width=20, fg="black", bg="snow", height=3, font=('kenit', 18, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, bg="white", fg="green", font=('times', 25, ' bold '))
...
clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="black"  ,bg="gray"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="ADMIN LOGIN",command=admin_panel,fg="white"  ,bg="black"  ,width=19 ,height=1, activebackground = "Red" ,font=('kenit', 15, ' bold '))
AP.place(x=505, y=620)

takeImg = tk.Button(window, text="TAKE IMAGE",command=take_img,fg="black"  ,bg="pale green"  ,width=20  ,height=3, activebackground = "Red" ,font=('kenit', 15, ' bold '))
takeImg.place(x=100, y=500)

trainImg = tk.Button(window, text="TRAIN IMAGE",fg="black",command=trainimg ,bg="pale green"  ,width=20  ,height=3, activebackground = "Red" ,font=('kenit', 15, ' bold '))
trainImg.place(x=500, y=500)

FA = tk.Button(window, text="AUTOMATIC ATTENDANCE",fg="black",command=subjectchoose  ,bg="pale green"  ,width=25  ,height=3, activebackground = "Red" ,font=('kenit', 15, ' bold '))
